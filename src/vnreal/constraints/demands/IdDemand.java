 ...
 * @since 2010-09-10
 */
public class IdDemand extends AbstractDemand implements INodeConstraint {
	protected String demandedId;
	...
	public IdDemand(String demandedId, Node<? extends AbstractConstraint> owner) {
		super(owner);
		this.demandedId = demandedId;
	}
	
	public IdDemand(String demandedId, Node<? extends AbstractConstraint> owner, String name) {
		super(owner, name);
		this.demandedId = demandedId;
	}
