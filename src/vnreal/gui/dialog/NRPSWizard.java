...
import vnreal.algorithms.NodeRanking;
import vnreal.core.Scenario;
import vnreal.gui.GUI;
import vnreal.network.NetworkStack;

@SuppressWarnings("serial")
public class NRPSWizard extends AbstractButtonDialog
	...
	protected JPanel createContent() {
		...
		snHorizontal.addGroup(snLayout.createParallelGroup().addComponent(
				cpuWLabel).addComponent(bwWLabel).addComponent(isDistanceLabel)
				.addComponent(maxDistLabel).addComponent(nodeOverloadLabel));
		snHorizontal.addGroup(snLayout.createParallelGroup().addComponent(
				cpuWSpinner, GroupLayout.PREFERRED_SIZE,
				...
				.addComponent(yesNodeOverloadButton,
						...
						noNodeOverloadButton, GroupLayout.PREFERRED_SIZE,
						GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE));
