...
/**
 * This metrics calculates the average node stress in the substrate 
...
public class AvNodeStress implements EvaluationMetric<NetworkStack> {
	...
	public double calculate(NetworkStack stack) {
		...
		for (SubstrateNode sn : sNetwork.getVertices())
			sumStress += VnrUtils.getStressLevel(sn);

		return (sumStress / (double) sNetwork.getVertices().size());
	}

	@Override
	public String toString() {
		// TODO Auto-generated method stub
		return "AverageNodeStress";
	}
