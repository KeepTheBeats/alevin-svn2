...
public final class IdResource extends AbstractResource implements
	...
	public IdResource(String id, Node<? extends AbstractConstraint> owner, SubstrateNetwork sNetwork) {
		super(owner);
		this.sNetwork = sNetwork;
		this.id = id;
	}
	
	public IdResource(String id, Node<? extends AbstractConstraint> owner, SubstrateNetwork sNetwork, String name) {
		super(owner, name);
		this.sNetwork = sNetwork;
		this.id = id;
	}
