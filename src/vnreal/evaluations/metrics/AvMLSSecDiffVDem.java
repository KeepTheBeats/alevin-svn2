...
/**
 * This Metric describes the Average difference between VNodes-Demand
 * 
 * @author Fabian Kokot
 *
 */
public class AvMLSSecDiffVDem implements EvaluationMetric<NetworkStack> {
