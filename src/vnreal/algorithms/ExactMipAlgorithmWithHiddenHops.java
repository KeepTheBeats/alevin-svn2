...
public class ExactMipAlgorithmWithHiddenHops extends GenericMappingAlgorithm {
	...
	public ExactMipAlgorithmWithHiddenHops(AlgorithmParameter param) {
		...
		this.nodeMappingAlgorithm = new CompleteNodeLinkMappingHiddenHop(
				distance, weightCpu, weightBw, nodeOverload);
