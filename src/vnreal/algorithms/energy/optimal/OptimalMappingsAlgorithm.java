...
public class OptimalMappingsAlgorithm extends AbstractAlgorithm {
	...
	public OptimalMappingsAlgorithm(NetworkStack stack,
			boolean allowMultipleMappings, int epsilon) {
		this.stack = stack;
	...
	void vnmFlib(NodeLinkMapping m, Collection<SubstrateNode> unmappedSNodes,
		...
		Collection<ResourceDemandEntry> demandedEnergyResources = new LinkedList<ResourceDemandEntry>();
