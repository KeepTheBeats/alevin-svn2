...
public class AddConstraintDialog extends AbstractAddEditConstraintDialog {
	public AddConstraintDialog(NetworkEntity<AbstractConstraint> ne, int lyr, Window owner,
			Dimension dim) {
	...
	protected Object[] getComboBoxObjects() {
		...
		String pckgname;
		if (layer == 0) {
			pckgname = "vnreal.constraints.resources";
		} else {
			pckgname = "vnreal.constraints.demands";
		}
