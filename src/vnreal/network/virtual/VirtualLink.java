...
public class VirtualLink extends Link<AbstractDemand> {
	...
	public Object VNFInputInterface = null;
	...
	public String toString() {
		return "VirtualLink(" + getId() + ")@" + getLayer() + " [" + get() + "]";
	}
	...
	public VirtualLink getCopy(boolean deepCopy) {
		return getCopy(deepCopy, new VirtualLink(getLayer()));
	}
	
	
	public VirtualLink getCopy(boolean deepCopy, VirtualLink clone) {
		clone.setName(getName());
		clone.VNFInputInterface = this.VNFInputInterface;
