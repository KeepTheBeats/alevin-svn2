package vnreal.generators.topologies;
...
public interface ITopologyGenerator {
	/**
	 * @return the name of the topology generator.
	 */
	public String getName();

	/**
	 * @return a string describing the topology generator and its current
	 *         state/configuration.
	 */
	public String toString();

	/**
	 * Generate a {@link SubstrateNetwork} using the topology generator's current
	 * configuration.
	 * 
	...
	/**
	 * Generate a {@link VirtualNetwork} using the topology generator's current
	 * configuration.
	 * 
	 * @param level
	...
	/**
	 * @return a {@link JPanel} that allows the user to configure the topology
	 *         generator. It will be displayed in its preferred size.
	 */
	public JPanel getConfigurationDialog();

	/**
	 * @return a cloned instance of the current {@link ITopologyGenerator}.
	 */
	public ITopologyGenerator clone();
}
