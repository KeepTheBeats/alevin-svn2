...
public class AvailableResourcesPathSplittingWizard extends AbstractButtonDialog
	...
	public AvailableResourcesPathSplittingWizard() {
	...
	protected JPanel createContent() {
		...
		snHorizontal.addGroup(snLayout.createParallelGroup()
				.addComponent(cpuWLabel).addComponent(bwWLabel)
