...
public class TestGenerator {
	...
	private ArrayList<SimpleEntry<String, Object[]>> params;
	...
	public void setParams(ArrayList<SimpleEntry<String, Object[]>> params) {
		this.params = params;
	}
	 ...
	 */
	public TestGenerator(int numRunsPerScenario) {
	...
	public TestSeries generateTests() {
		...
		for(TestRun tr : generateTestRuns(params, null)) {
