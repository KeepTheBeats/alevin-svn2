...
import vnreal.algorithms.DPVNE.*;
...
//				new ExactMipHhWizard(scenario);
			}else if (cmd.equals("DPVNE")) {
				ClassLoader classLoader= Main.class.getClassLoader();
		        try {
		            Class<?> loadClass = classLoader.loadClass("vnreal.algorithms.DPVNE.Main");
		            java.lang.reflect.Method method = loadClass.getMethod("main", String[].class);
...
//				new EnergyWizardHiddenHop(scenario);
				...
				SubgraphIsomorphismStackAlgorithm subgraph = new SubgraphIsomorphismStackAlgorithm(
						ns, new SubgraphIsomorphismAlgorithm());
			    ...
			    SubgraphIsomorphismStackAlgorithm aSubgraph = new SubgraphIsomorphismStackAlgorithm(
						ns, new AdvancedSubgraphIsomorphismAlgorithm());
