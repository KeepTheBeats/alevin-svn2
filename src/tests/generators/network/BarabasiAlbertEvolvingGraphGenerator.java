 ...
 */
public class BarabasiAlbertEvolvingGraphGenerator <T extends AbstractConstraint, V extends Node<T>, E extends Link<T>, N extends Network<T, V, E>>
	implements EvolvingGraphGenerator<V, E> {
	
	NetworkFactory<T, V, E, N> factory = null;
    private N mGraph = null;
     ...
     */
    public BarabasiAlbertEvolvingGraphGenerator(NetworkFactory<T, V, E, N> factory,
    		int init_vertices, int numEdgesToAttach, 
            Random random, Set<V> seedVertices,
        ...
        initialize(seedVertices, autoUnregisterConstraints);
    }
    ...
    public BarabasiAlbertEvolvingGraphGenerator(NetworkFactory<T, V, E, N> factory,
    		...
    		boolean autoUnregisterConstraints,
    		boolean directed) {
        this(factory, init_vertices, numEdgesToAttach, new Random(), seedVertices, autoUnregisterConstraints, directed);
    }
    
    private void initialize(Set<V> seedVertices, boolean autoUnregisterConstraints) {
    	
    	mGraph = factory.create();
