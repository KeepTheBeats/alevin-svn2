...
import vnreal.constraints.resources.LinearCpuEnergyResource;
 ...
 */
@GeneratorParameter(
		parameters = { "Networks:Networks", "TR:Min_LCE_Base", "TR:Max_LCE_Base", "TR:Min_LCE_Factor", "TR:Max_LCE_Factor"}
		)
public class RandomLinearCpuEnergyResourceGenerator extends AbstractResourceGenerator<List<LinearCpuEnergyResource>> {
