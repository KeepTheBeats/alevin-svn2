 ...
 */
public class AvSecSpreadProvDem implements EvaluationMetric<NetworkStack> {
	...
	public double calculate(NetworkStack stack) {
		...
		for (SubstrateNode sn : sNetwork.getVertices()) {
            	    double returnedValue = VnrUtils.getSecuritySpreadProvDem(sn);
