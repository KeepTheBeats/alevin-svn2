				...
				for (int numSNodes : numSNodesArray)
					for (double rho : rhoArray) {
						...
						output.write(Double.toString(MiscelFunctions
								...
								+ "\t\t"
								+ Double.toString(MiscelFunctions
										.round(linkUtilization, 3))
								+ "\t\t"
								+ Double.toString(MiscelFunctions
										.round(nodeUtilization, 3))
								+ "\t\t"
								+ Double.toString(MiscelFunctions
										.round(maxLinkStress, 3))
								+ "\t\t"
								+ Double.toString(MiscelFunctions
										.round(maxNodeStress, 3))
								+ "\t\t"
								+ Double.toString(MiscelFunctions
										.round(perAcceptedVNR, 3))
								+ "\t\t"
								+ Double.toString(MiscelFunctions
										.round(perMappedRevenue, 3))
								+ "\t\t"
								+ Double.toString(MiscelFunctions
										.round(remaLinkRes, 3))
								+ "\t\t"
