...
import vnreal.algorithms.BFSCoordinated;
import vnreal.core.Scenario;
import vnreal.gui.GUI;
import vnreal.network.NetworkStack;

@SuppressWarnings("serial")
public class BFSNRPSWizard extends AbstractButtonDialog implements
		ActionListener {
	...
	protected JPanel createContent() {
		...
		JLabel kLabel = new JLabel("Maximum number of hops to Explore");
		...
		snHorizontal.addGroup(snLayout.createParallelGroup().addComponent(
				kLabel).addComponent(cpuWLabel).addComponent(bwWLabel)
				.addComponent(isDistanceLabel).addComponent(maxDistLabel)
				.addComponent(nodeOverloadLabel));
		snHorizontal.addGroup(snLayout.createParallelGroup().addComponent(
				kSpinner, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
				GroupLayout.PREFERRED_SIZE).addComponent(cpuWSpinner,
				GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
				GroupLayout.PREFERRED_SIZE).addComponent(bwWSpinner,
				GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
		...
		snVertical.addGroup(snLayout.createParallelGroup(
				GroupLayout.Alignment.CENTER).addComponent(cpuWLabel)
				.addComponent(cpuWSpinner, GroupLayout.PREFERRED_SIZE,
						GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE));

		snVertical.addGroup(snLayout.createParallelGroup(
				GroupLayout.Alignment.CENTER).addComponent(bwWLabel)
