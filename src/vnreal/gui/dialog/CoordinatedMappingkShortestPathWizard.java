...
public class CoordinatedMappingkShortestPathWizard extends AbstractButtonDialog {
	...
	static String ramdomizedString = "Randomized";
	...
	public CoordinatedMappingkShortestPathWizard() {
