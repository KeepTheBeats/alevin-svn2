...
public final class ScenarioImporterExporterTest {
	...
	public void importExportImportAgainTest() {
		try {
			...
			XMLExporter.exportStack("src/XML/exemplary-scenario-test.xml", scenario.getNetworkStack());
	...
	public void importExportImportAgainTestWithMappings() {
		try {
			...
			XMLExporter.exportStack("src/XML/exemplary-scenario-mappings-test.xml", scenario.getNetworkStack());
	...
	public void importExportImportAgainTestWithMappingsAndHiddenHops() {
		try {
			...
			XMLExporter.exportStack("src/XML/exemplary-scenario-mappings-and-hiddenhops-test.xml", scenario.getNetworkStack());
