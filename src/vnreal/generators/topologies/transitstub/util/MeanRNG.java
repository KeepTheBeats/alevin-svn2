package vnreal.generators.topologies.transitstub.util;
...
public class MeanRNG {
	...
	public MeanRNG(int size, int mean, int iterationFactor, Random random) {
		this.init(size, mean, iterationFactor, random);
	}
