...
/**
 * The random {@link PhysicalDemandedSecurity} Generator  with seed
 * 
 * @author Fabian Kokot
 *
 */
...
public class FixedPhysicalDemandedSecurityResourceGenerator extends AbstractResourceGenerator<List<PhysicalDemandedSecurity>> {
