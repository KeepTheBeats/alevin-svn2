 ...
 *
 */
public class MlsNodeMapping_Unique extends AbstractNodeMapping {
	

	public MlsNodeMapping_Unique(SubstrateNetwork sNet, boolean subsNodeOverload) {
	...
	protected boolean nodeMapping(SubstrateNetwork sNet, VirtualNetwork vNet) {
		...
		if(!isPreNodeMappingFeasible(sNet, vNet))
